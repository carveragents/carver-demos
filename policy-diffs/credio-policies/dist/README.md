...
Powered by [Carver Agents](https://carveragents.ai). Acme Pay is a fictional company; all policies shown are synthetic baselines.
...
- Eight Acme Pay policy pages with per-policy mini-timelines
...
The agent runs three stages on each pair of consecutive SPME releases: **detect** changed sections, **classify** severity (breaking / substantive / clarifying / cosmetic), and **propose** corresponding edits to the eight Acme Pay policies.

---

## What this is *not*

- The Acme Pay policies are synthetic baselines, not real production text
