"""Aggregate jurisdiction event counts across time windows for choropleth analysis."""
...
def main():
    ...
    windows, rec_count, valid, skip = aggregate(repo_root / "data/_scratch/annotations.jsonl", today)

    report = [
        "# Choropleth Density Analysis — US States (Stage 1 Annotations)",
        "",
    ...
    (repo_root / "data/a9-choropleth-density.md").write_text("\n".join(report))
    print(f"Report written to data/a9-choropleth-density.md")
